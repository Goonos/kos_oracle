...
const DATA = {
    ...
    blogLogs: [
        {
            date: "2026-06-23",
            title: "[Oracle] Execution Plan(실행 계획) 보는 법 완벽 정리",
            summary: "성능 튜닝의 첫걸음인 Row Source Operation과 Cost, Card의 개념을 예제를 통해 정리했습니다.",
            tags: ["Oracle", "Tuning"],
            link: "https://velog.io/@your-id/oracle-explain-plan" // 실제 블로그 링크를 넣으세요!
        },
        {
            date: "2026-06-22",
